...
##### 25.10.2023 | Prof. Dr. phil. Stephan Goerigk
...
* Dieser Unterschied ist unser sogenannter Vorhersagefehler oder auch **Residuum** 
  ...
  * Das Residuum wird mit $\epsilon_i$ bezeichnet
...
$$\sum\limits _{i=1}^{n}\epsilon^2_i=\epsilon^2_1+\epsilon^2_2...+\epsilon^2_n \rightarrow \min_{a,b}$$
]
