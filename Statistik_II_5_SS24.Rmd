...
##### 21.11.2023 | Prof. Dr. phil. Stephan Goerigk
...
$$\bar{UV_1UV_2}_{ij} = \bar{G} + \hat{\alpha}_i + \hat{\beta}_j = \bar{G} + (\bar{UV_1i} - \bar{G}) +   (\bar{UV_2j} - \bar{G}) = \bar{UV_1i} + \bar{UV_2j} - \bar{G}$$
---
class: top, left
### Mehrfaktorielle ANOVA
...
$$\bar{UV_1UV_2}_{11}= 16 + 18 - 22.25 = 11.75$$
...
$$\bar{UV_1UV_2}_{22}= 28.5 + 26.5 - 22.25 = 32.75$$
...
$$\bar{G}= `r round(mean(df$Verbesserung), 2)`$$
$$\hat{\sigma}^2_{UV_1\text{x}UV_2}= \frac{4 \cdot [11.75  - (16 + 18 - 22.25)]^2 + ... + [32.75  - (28.5 + 26.5 - 22.25)]^2}{(2-1) \cdot (2-1)}=196$$
