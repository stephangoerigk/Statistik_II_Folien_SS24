...
##### 10.11.2023 | Prof. Dr. phil. Stephan Goerigk
...
* Vorgehen: Regressionsgewicht muss von Originalmetrik des untersuchten Merkmals $(Y)$ bereinigt werden
  ...
  * Zähler- und Nennnereinheiten werden an der Streuung von $Y$ und $X$ relativiert
...
2. Der Prädiktor (UV) kann entweder intervallskaliert und normalverteilt oder dichotom nominalskaliert sein.
