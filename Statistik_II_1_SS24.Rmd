...
# setwd("/Users/nicosteffen/Library/Mobile Documents/com~apple~CloudDocs/Documents/Arbeit/CFH/01 Stephan Goerigk/R/Stephan_GitHub/Statistik_II_Folien_SS23")
...
##### `r format(as.Date(data.frame(readxl::read_excel("Modul Quantitative Methoden II_Termine.xlsx"))$Datum), "%d.%m.%Y")[1]` | Prof. Dr. phil. Stephan Goerigk
